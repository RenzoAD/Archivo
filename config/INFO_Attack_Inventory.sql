SELECT	
		...
		CONVERT(varchar(10),max_FI.ult_ingreso, 103) AS Fecha_ult_ing, 
		max_FI.cant AS Cant_ult_ing, 
		DATEDIFF(DAY, max_FI.ult_ingreso, GETDATE()) AS Dias_dsd_ult_ing,
		CONVERT(varchar(10), max_k.ultimaVenta, 103) AS Fecha_Ult_vta, 
		DATEDIFF(DAY, max_k.ultimaVenta, GETDATE()) AS Dias_Ult_vta
